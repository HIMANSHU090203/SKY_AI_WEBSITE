...
const Footer = () => (
  <footer className="bg-gradient-to-t from-black to-gray-900 border-t border-green-500/30 backdrop-blur-sm relative z-10 pt-16 pb-8">
    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col md:flex-row md:justify-between md:items-start gap-12">
      ...
      <div className="flex-1 min-w-[260px] mb-8 md:mb-0">
        ...
        <div className="flex items-center gap-4 mt-4">
          <a href="mailto:info@sky-ai.in" className="text-gray-400 hover:text-green-400 transition-colors text-sm flex items-center gap-2">
          ...
          <a href="tel:+91 9783982649" className="text-gray-400 hover:text-green-400 transition-colors text-sm flex items-center gap-2">
      ...
      <div className="flex-1 min-w-[180px] mb-8 md:mb-0">
        ...
        <ul className="space-y-2 text-gray-400 text-sm">
          ...
          <li><Link href="/Aboutus" className="hover:text-green-400 transition-colors">About Us</Link></li>
          <li><Link href="/Careers" className="hover:text-green-400 transition-colors">Careers</Link></li>
          <li><Link href="/Blogs" className="hover:text-green-400 transition-colors">Blogs</Link></li>
      ...
      <div className="flex-1 min-w-[220px]">
        ...
        <div className="flex gap-4 mb-4">
          ...
          <a href="https://www.linkedin.com/company/sky-advanced-research-llp/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-400 transition-colors">
    ...
    <div className="border-t border-green-500/30 mt-12 pt-8 text-center">
